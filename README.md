...
- **Calibrated Motion Sensitivity** — Tuned with +15% enhanced sensitivity for ultra-responsive, effortless gentle wrist shakes while preserving intelligent touch suppression so tapping buttons, tabs, or menus never triggers accidental shakes.
...
- **PWA & Mobile Ready** — Responsive layout with bottom navigation tabs, drawer menus, progressive web app manifest, cache invalidation, and iOS home screen installation support.
...
2. Shake your phone naturally with a gentle wrist motion — the jar rattles and your activity star is drawn instantly with enhanced sensitivity.
